...
import { FakeValuService } from './value-fake.service';
...
describe('MasterService', () => {
  ...
  //   const fakeValue = new FakeValuService();
  //   const masterService = new MasterService(
  //     fakeValue as unknown as ValueService
  //   );
  ...
  it('should call to getValue from ValueService with type', () => {
  ...
  it('should call to getValue from ValueService with type and TestBed', () => {
    valueServiceSpy.getValue.and.returnValue('fake value');
    expect(masterService.getValue()).toBe('fake value');
    expect(valueServiceSpy.getValue).toHaveBeenCalled();
    expect(valueServiceSpy.getValue).toHaveBeenCalledTimes(1);
